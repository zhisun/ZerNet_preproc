...
fprintf('%2.4fs\n',elapsed_time);
%
sampled_surface = struct('X',[shape.X,shape.Y,shape.Z],'F',shape.TRIV,'label_X',shape.label_V,'label_F',shape.label_F',...
                'I',resample_graph.I,'B',resample_graph.B,'N_X',resample_graph.N_X,'N_label',resample_graph.N_label);
%
