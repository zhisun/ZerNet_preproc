function ZerPatch = compute_ZerPatch(shape,resample_graph,disk_R,n_rays,cut_num,zernike_order,num_bases)
...
for Xid = 1:length(X)
    ...
    %can be set case by case
    lower_bound = disk_R/4;
